...
import com.android.luomeiji_driver.UI.legalizeresult.LegalizeresultwithActivity
...
import kotlinx.android.synthetic.main.activity_carlegalize_two.*
import kotlinx.android.synthetic.main.activity_carowner_two.*
import java.io.File
import java.text.SimpleDateFormat
import java.util.*

class CarLegalize_TwoActivity : LBaseAppCompatActivity<CarLegalize_TwoPersenter>(),
    ICarLegalize_TwoView {
    override fun carlegalizetwosuccess(string: String) {
        startActivity(Intent(this, LegalizeresultwithActivity::class.java))
    }

    override fun carlegalizetwoerror(string: String) {
        MyToast.showMsg(string)
    }

    override fun initlayout(): Int {
        return R.layout.activity_carlegalize_two
    }
    ...
    override fun initView() {
        ...
        carlegalize_two_next.setOnClickListener {
            if (phonefile1 == null) {
                MyToast.showMsg("请上传车辆正面照片")
                return@setOnClickListener
            }
            if (phonefile2 == null) {
                MyToast.showMsg("请上传购车证明资料")
                return@setOnClickListener
            }
            if (phonefile3 == null) {
                MyToast.showMsg("请上传车辆保险资料")
                return@setOnClickListener
            }
            mPersenter!!.carlegalize_two(carid, phonefile1!!, phonefile2!!, phonefile3!!)
        }
    }

    override fun initPersenter() {
        mPersenter = CarLegalize_TwoPersenter(this, this)
    }
